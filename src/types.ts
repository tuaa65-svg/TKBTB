...
export interface SchoolInfo {
  ...
  hasSpecialNeedsStudent?: boolean; // Lớp có học sinh khuyết tật / hòa nhập (chỉ nêu yêu cầu cần đạt khi có học sinh khuyết tật)
  specialNeedsDescription?: string; // Mô tả điều chỉnh cho học sinh khuyết tật
}
...
export interface ScheduleItem {
  ...
  teacherName?: string;
  className: string;
  isSpecialistPeriod?: boolean; // Tiết dạy của GV chuyên / bộ môn
  specialistTeacherName?: string; // Tên ngắn gọn của GV chuyên (vd: "Thầy Thy", "Cô Nương", "Thầy Nhàn")
}
...
export interface LessonPlan {
  ...
  objectives: {
    ...
    specialNeedsObjective?: string; // 5. Yêu cầu cần đạt đối với học sinh khuyết tật (chỉ nêu khi lớp có HS khuyết tật)
    integrations?: {
